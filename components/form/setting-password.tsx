...
export default function FormSettingPassword({className, ...props}: React.ComponentProps<"form">) {
	...
	const onSubmit = async (values: z.infer<typeof formSchema>): Promise<void> => {
		const action: TransactionAction<UserEntity | UnauthorizedResponse | BadRequestResponse> = await userChangePasswordAction(values);
		if (!action.isSuccess) {
